...
/* ** argv: Values of arguments */
{
    ...
    {
        jacobi_iteration(AB, RHS, SOL, &lab, &la, &ku, &kl, &tol, &maxit, resvec, &nbite);
    }
    else if (IMPLEM == GS)
    {
        gauss_seidel_iteration(AB, RHS, SOL, &lab, &la, &ku, &kl, &tol, &maxit, resvec, &nbite);
    }
    ...
    double error = compute_error(SOL, EX_SOL, &la);
